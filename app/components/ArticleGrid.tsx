    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className={`bg-blue-500 dark:bg-blue-700 text-white dark:text-gray-100`}>
            <CardContent className="p-6">
              ...
              <p className="text-xs text-gray-200 dark:text-gray-300">2024-12-31</p>
            </CardContent>
          </Card>

          <Card className={`bg-purple-500 dark:bg-purple-700 text-white dark:text-gray-100`}>
            <CardContent className="p-6">
              <div className="mb-4 w-12 h-12 bg-white/10 dark:bg-white/20 rounded-lg flex items-center justify-center">
          ...
          <Card className={`bg-gradient-to-br from-blue-400 to-blue-100 dark:from-blue-600 dark:to-blue-800 text-blue-900 dark:text-white`}>
            <CardContent className="p-6">
              <div className="mb-4 w-12 h-12 bg-white/10 dark:bg-white/20 rounded-lg flex items-center justify-center">
              ...
              <p className="text-sm mb-2">지금 소비자가 좋아는 콘텐츠는 무엇일까요? 깊이를 소리 트렌드 분석을 분석해 봅니다.</p>
            </CardContent>
          </Card>
        </div>
    );
